...
public class DictionaryProvider extends ContentProvider {
  ...
  public static String AUTHORITY = "net.macarel.android.cantalausa.DictionaryProvider";
  public static String pattern = "<.*?>";
    ...
    public static final Cursor convertCursor(Cursor cursor){
...
//        		if (DictionaryDatabase.KEY_DEFINITION.equals(cursor.getColumnName(i))){
...
/*        SearchManager.SUGGEST_COLUMN_SHORTCUT_ID,
      ...
      Cursor cursor =mDictionary.getWordMatches(query, columns);
      Cursor newCursor = DictionaryProvider.convertCursor(cursor);
      cursor.close();
      return newCursor;
