...
//    private static final String TAG = "SearchableDictionary";
    ...
    private TextView mTextView; // prompt line to use search box
    ...
    private void showResults(String query) {
        ...
        Cursor cursorOriginal = managedQuery(DictionaryProvider.CONTENT_URI, null, null,
                                new String[] {query}, null);
        Cursor cursor = DictionaryProvider.convertCursor(cursorOriginal);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.about: {
            	...
            	about.setTitle(R.string.about_this_app);
            	about.show();
               return true;
            }
            default:
